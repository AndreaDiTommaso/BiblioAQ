...
CREATE TABLE biblioteche (
	...
	posti_liberi TINYINT(3) NOT NULL,
...
INSERT INTO biblioteche VALUES (NULL, 'La tana di Lupoleone', 30,30,'8:00-18:00','348 074 7694','Via Antica Arischia, 20','42.37060138538752', '13.366074415740936','bella biblioteca','lupoleone.jpg');
INSERT INTO biblioteche VALUES (NULL, 'Biblioteca Provinciale Salvatore Tommasi', 30,30,'8:00-18:00','086261964','Piazza del Palazzo, 30','42.35089219757118', '13.39926230167777','bella biblioteca','S_Tommasi.jpg');
...
INSERT INTO libri VALUES (NULL, 'it', 'Stephen King','Sperling & Kupfer','horror',1,'La tana di Lupoleone', TRUE,'A Derry, una piccola cittadina del Maine, per un bambino come George Denbrough il più grande divertimento è seguire la barchetta di carta che gli ha costruito il fratello maggiore Bill. Ma le strade sono sdrucciolevoli e George rischia di perdere il suo giocattolo, che infatti si infila in un canale di scolo lungo il marciapiede e sparisce nelle viscere della terra. Cercare di recuperarlo è l\'ultimo gesto di George: una creatura spaventosa travestita da clown gli strappa un braccio uccidendolo.','it.jpg');
INSERT INTO libri VALUES (NULL, 'L\' assassinio di Roger Ackroyd', 'Agatha Christie','Mondadori','giallo',2,'Biblioteca Provinciale Salvatore Tommasi', TRUE,'King\'s Abbot è un paesino della campagna inglese dove tutti si conoscono e non succede mai nulla di speciale. Un giorno però qualcosa accade: l\'uomo più ricco del paese, Roger Ackroyd, viene assassinato proprio quando stava per leggere una lettera che avrebbe fatto luce su un misterioso suicidio. Il delitto getta nello sgomento la comunità. Non tutti però hanno da dolersi dell\'accaduto,un uomo, l\'ineguagliabile Poirot, riesce a scoprire che la realtà è ben diversa da quella che appariva...','assassinio.jpg');
